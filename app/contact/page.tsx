  ...
  return (
    <section className="px-6 py-12 max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p><strong>Location:</strong> Piassa, Addis Ababa, Ethiopia</p>
        <p><strong>Phone:</strong> +251 93 220 9141</p>
        <p><strong>Email:</strong> zemenaytechsolutions@gmail.com</p>
        <p><strong>Business Hours:</strong> Mon–Fri: 9 AM – 6 PM | Sat: 10 AM – 2 PM</p>
      </div>
    </section>
  );
}
